...
var Clock = Clock || (function(domObject, seconds){
...
function element(number, name, small) {
    ...
    console.log('data in object 1111111 = ' + data.elements);
			...
			for (var i = 0; i <= data.elements.length-1; i++) {
				...
				//var varTemp = document.createElement('div');
				  ...
				  elementsHour[i].className = 'element ' + data.elements[i].color;
				...
				//var varTemp = document.createElement('div');
				  ...
				  elementsMin[i].className = 'element ' + data.elements[i].color;
				  //elementsHour[i].innerHTML = data.elements[i].number;
				...
				// CREATE SECONDS ELEMENTS
				  ...
				  // 				  elementsSec[i].className = 'element ' + data.elements[i].color;
  ...
  function startFade() {
	...
	document.getElementById('myClock').innerHTML = hSpin+":"+mSpin;

    //secTime = currentVert;

    console.log('secTime = ' + secTime);
    console.log('hSpin = ' + hSpin + ': hSpinPrev = ' + hSpinPrev);
    console.log('mSpin = ' + mSpin);
    //console.log('sSpin = ' + sSpin + ': sSpinPrev = ' + sSpinPrev);
    ...
    // elementsSec[sSpinPrev].style.opacity = "0";
    //     elementsSec[sSpin].style.opacity = "1";

	elementsMin[mSpinPrev].style.opacity = "0";
    elementsMin[mSpin].style.opacity = "1";

	elementsHour[hSpinPrev].style.opacity = "0";
